class Client:
    def __init__(self, first_name="Consumidor", last_name="Final", dni="9999999999",address="xxxxxxx",phone="099999999",tipo_client= "xxxxxxxxxxxxx"):
        # Método constructor para inicializar los atributos de la clase Cliente
        self.first_name = first_name
        self.last_name = last_name
        self.address = address
        self.phone = phone
        self.tipo_client = tipo_client
...
class RegularClient(Client):
    def __init__(self, first_name="Cliente", last_name="Final", dni="9999999999", card=False,address="xxxxxxx",phone="099999999",tipo_client="xxxxxxx"):
        # Método constructor para inicializar los atributos de la clase RetailClient
        super().__init__(first_name, last_name, dni,address,phone,tipo_client)  # Llama al constructor de la clase padre
    ...
    def getJson(self):
        # Método para imprimir los detalles del cliente minorista en la consola
        return {"dni":self.dni,"nombre":self.first_name,"apellido":self.last_name,"valor": self.discount,"adress":self.address,"phone":self.phone,"tipoclient":self.tipo_client}


class VipClient(Client):
    def __init__(self, first_name="Consumidor", last_name="Final", dni="9999999999",address="xxxxxxx",phone="099999999",tipo_client="xxxxxxxxxx"):
    ...
    def getJson(self):
        # Método para imprimir los detalles del cliente VIP en la consola
        return {"dni":self.dni,"nombre":self.first_name,"apellido":self.last_name,"valor": self.limit,"adress":self.address,"phone":self.phone,"tipoclient":self.tipo_client}
